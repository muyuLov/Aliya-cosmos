...
from core.tts.exceptions import TTSConfigError, TTSProviderNotFoundError
from core.tts.models import VoiceConfig
from core.tts.providers.base import TTSProviderFactory
from core.tts.service import TTSService

_logger = get_logger(__name__)


def create_player(player_config: dict[str, Any] | None = None):
    """
